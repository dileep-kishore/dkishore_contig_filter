...
This sample module contains one small method that filters contigs.
    ...
    def run_dkishore_contig_filter(self, ctx, params):
        """
        ...
        #BEGIN run_dkishore_contig_filter

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_dkishore_contig_filter function. Params=' + pformat(params))
        ...
        #END run_dkishore_contig_filter

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_dkishore_contig_filter return value ' +
